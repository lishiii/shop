...
public class UserServiceImpl implements UserService {
	...
	/**
	 * 注册校验 是否有username\phone\email 进行过注册 没有则返回TaotaoResult.ok(true)
	 * 有则返回TaotaoResult.ok(false)
	 */
	@Override
	...
	@Override
	public TaotaoResult logoutUser(HttpServletRequest request,
			HttpServletResponse response, HttpSession session) {
		// TODO 空指针异常
		// String token = (String) session.getAttribute("TT_TOKEN");
